          ...
          GridView(
            ...
            children: [
              ...
              DashboardTile(
                  ...
                  // bgColor: Colors.deepPurple),
              DashboardTile(
                  info: 'Total Reviews', count: 0, icon: LineIcons.starAlt, bgColor: Colors.teal),
              // info: 'Total Reviews', count: ref.watch(reviewsCountProvider).value ?? 0, icon: LineIcons.starAlt, bgColor: Colors.teal),
            ],
          ),
